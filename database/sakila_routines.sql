...
--
-- Temporary view structure for view `showdata`
--

DROP TABLE IF EXISTS `showdata`;
/*!50001 DROP VIEW IF EXISTS `showdata`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `showdata` AS SELECT 
 1 AS `amount`,
 1 AS `payment_date`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `showdata`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `showdata` AS select `payment`.`amount` AS `amount`,`payment`.`payment_date` AS `payment_date` from `payment` where (`payment`.`amount` < 2) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-06-28 12:30:15
